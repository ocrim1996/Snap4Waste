...
trucks_load = pd.read_csv(os.path.join(settings.csv_folder, "ams_trucks_paths_yearly_14000.csv"))
...
trucks_load.to_csv(os.path.join(settings.csv_folder, "ams_trucks_load_yearly_14000.csv"), encoding='utf-8', index=False)
...
plt.savefig(os.path.join(settings.outputs_folder, "ams_distribution_trucks_load_14000.jpeg"))
plt.show()

trucks_num = pd.read_csv(os.path.join(settings.csv_folder, "ams_trucks_load_yearly_14000.csv"))
trucks_num = trucks_num.groupby(['date']).size().reset_index(name='tot_trucks')
trucks_num.to_csv(os.path.join(settings.csv_folder, "ams_trucks_num_14000.csv"), encoding='utf-8', index=False)
...
plt.ylabel("Frequency")
plt.savefig(os.path.join(settings.outputs_folder, "ams_distribution_trucks_num_14000.jpeg"))
plt.show()
