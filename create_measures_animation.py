...
<div class='legend-title'>Type of Measures</div>
<div class='legend-scale'>
  <ul class='legend-labels'>
    <li><span style='background:blue;opacity:0.7;'></span> ≤ 1500 Kg </li>
    <li><span style='background:red;opacity:0.7;'></span> > 1500 Kg </li>
